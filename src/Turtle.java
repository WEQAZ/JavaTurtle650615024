...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        // call turtle on the screen
        Turtle bob = new Turtle();
        bob.penColor("blue");
        bob.width(13.5);
        
        //set turtle start position
        bob.up();
        bob.setPosition(-230, -80);
        bob.down();
        ...
        for (int index = 0; index < 6; index++) {
            ...
            bob.setDirection(310);
            bob.forward(50); 
        }
        
        // make apex line 
        bob.setDirection(130);
        bob.forward(285);
        bob.setDirection(227);
        bob.forward(285);

        // set position of the turtle in the middle of umbrella
        bob.up();
        bob.setPosition(-40, -80);
        bob.down();
